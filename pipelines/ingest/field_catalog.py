...
CURATED_OVERLAY_STYLES: dict[str, dict[str, object]] = {
    ...
    "specific_humidity_2m": VARIABLE_STYLES["SPFH"],
    "temperature_potential_2m": VARIABLE_STYLES["POT"],
    ...
    "cin_surface": VARIABLE_STYLES["CIN"],
    "visibility": VARIABLE_STYLES["VIS"],
    "cloud_cover_total": VARIABLE_STYLES["TCDC"],
    "cloud_cover_low": VARIABLE_STYLES["LCDC"],
    "cloud_cover_mid": VARIABLE_STYLES["MCDC"],
    "cloud_cover_high": VARIABLE_STYLES["HCDC"],
    "ceiling": VARIABLE_STYLES["HGT"],
    "land_mask": VARIABLE_STYLES["LAND"],
    "gust_surface": VARIABLE_STYLES["GUST"],
    "surface_pressure": VARIABLE_STYLES["PRES"],
    "pressure_surface": VARIABLE_STYLES["PRES"],
    "height_0c_isotherm": VARIABLE_STYLES["HGT"],
    "rh_0c_isotherm": VARIABLE_STYLES["RH"],
    "wind_0c_isotherm": VARIABLE_STYLES["WIND"],
    "u_wind_0c_isotherm": VARIABLE_STYLES["UGRD"],
    "v_wind_0c_isotherm": VARIABLE_STYLES["VGRD"],
    "u_wind_10m": VARIABLE_STYLES["UGRD"],
    "v_wind_10m": VARIABLE_STYLES["VGRD"],
    "u_wind_80m": VARIABLE_STYLES["UGRD"],
    "v_wind_80m": VARIABLE_STYLES["VGRD"],
    "height_500mb": VARIABLE_STYLES["HGT"],
    "height_700mb": VARIABLE_STYLES["HGT"],
    "height_850mb": VARIABLE_STYLES["HGT"],
    "temperature_850mb": VARIABLE_STYLES["TMP"],
    "temperature_700mb": VARIABLE_STYLES["TMP"],
    "temperature_925mb": VARIABLE_STYLES["TMP"],
    "specific_humidity_700mb": VARIABLE_STYLES["SPFH"],
    "specific_humidity_850mb": VARIABLE_STYLES["SPFH"],
    "wind_10m": VARIABLE_STYLES["WIND"],
    "wind_speed_80m": VARIABLE_STYLES["WIND"],
    "wind_500mb": VARIABLE_STYLES["WIND"],
    "wind_700mb": VARIABLE_STYLES["WIND"],
    "wind_850mb": VARIABLE_STYLES["WIND"],
    "u_wind_500mb": VARIABLE_STYLES["UGRD"],
    "v_wind_500mb": VARIABLE_STYLES["VGRD"],
    "vertical_velocity_500mb": VARIABLE_STYLES["VVEL"],
    "vertical_velocity_700mb": VARIABLE_STYLES["VVEL"],
    "helicity_0_1km": VARIABLE_STYLES["HLCY"],
    "helicity_0_3km": VARIABLE_STYLES["HLCY"],
    "storm_motion_u": VARIABLE_STYLES["USTM"],
    "storm_motion_v": VARIABLE_STYLES["VSTM"],
    "shear_u_0_1km": VARIABLE_STYLES["VUCSH"],
    "shear_v_0_1km": VARIABLE_STYLES["VVCSH"],
    "shear_u_0_6km": VARIABLE_STYLES["VUCSH"],
    "shear_v_0_6km": VARIABLE_STYLES["VVCSH"],
    "relative_vorticity_0_1km": VARIABLE_STYLES["RELV"],
    "relative_vorticity_0_2km": VARIABLE_STYLES["RELV"],
